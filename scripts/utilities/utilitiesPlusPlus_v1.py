...
class processData:
    ...
    def extractData(self, rootFile, root_dir, ret = False, verbose = False):
        ...
        self.fileName = rootFile.split("/")[-1]
        print("\n\n")
        print(60 * '*')
        print(colors.GREEN + "Extracting data from %s" % self.fileName + colors.ENDC)
        print(60 * '*')
        #print("\n\n")
    ...
    def SSM(self, ret = False, verbose = False, extraInfo = False):
        ...
        for event in tqdm(range(self.selMu_chargeCut.shape[0])):
            ...
            if verbose:
                ...
                print("gen chargeopo[1]: ", genChargeopo[1])
    ...
    def fillAndSort(self, sep = True, save = False, ret = True):

        print("\n\n")
        print(60 * '*')
        print(colors.GREEN + "Filling final array" + colors.ENDC)
        print(60 * '*')
        #print("\n\n")
    ...
    def fillFinalArray(self, numbering = True, perm = True, diMu_dRBool = True, save = False, pandas = False, ret = True, verbose = False):
        print("\n\n")
        print(60 * '*')
